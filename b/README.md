# Beta registry landing page — Terminal direction

*You are logging in, not browsing. Phosphor green on black, scanlines, a blinking cursor and a command prompt for an email field.*
